...
while 001A:   3 > $COUNTER_4X4_PICKUPS 
	...
	if and
		0018:   $INTRO_TIME_LAPSED > 2000 
		0038:   $FLAG_INTRO == 3
	then
		0160: point_camera $X_1 $Y_1 $Z_1 switchstyle INTERPOLATION
		0004: $FLAG_INTRO = 4 
	end
	if and
		0018:   $INTRO_TIME_LAPSED > 3000 
		0038:   $FLAG_INTRO == 4
	then
		016A: fade 0 for 1500 ms
		while fading
